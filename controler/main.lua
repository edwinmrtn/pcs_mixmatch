...
dofile("sys/lua/pcs_mixmatch/controler/onteam.lua")
dofile("sys/lua/pcs_mixmatch/controler/onmapchange.lua")
...
dofile("sys/lua/pcs_mixmatch/controler/onleave.lua")
